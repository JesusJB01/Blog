        ...
        <div className= " py-24 px-6 sm:py-32 lg:px-8">
          ...
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-2 text-lg font-semibold leading-8 text-indigo-600">
              !Agradecemos tus comentarios y sugerencias, nos tomamos en serio tu opinion o solicitud!
            </p>
            ...
            <div className="grid grid-cols-1 gap-y-6 gap-x-8 sm:grid-cols-2">
              ...
              <Switch.Group as="div" className="flex gap-x-4 sm:col-span-2">
                ...
                <Switch.Label className="text-sm leading-6 text-gray-600">
                  Al seleccionar esto, usted acepta nuestro{" "}
